...
if ( ! function_exists( 'akabane_theme_setup' ) ) {
...
function akabane_enqueue_assets() {
    ...
    wp_enqueue_style( 'akabane-custom', get_template_directory_uri() . '/assets/css/custom.css', array( 'akabane-style' ), $theme_version );

    wp_enqueue_script( 'akabane-main', get_template_directory_uri() . '/assets/js/main.js', array(), $theme_version, true );
}
